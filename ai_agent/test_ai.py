...
"""
    ...
    try:
        ...
        initial_state = ChartCheckState(chart_image_path = f"./test/test_image2.png")
        ...
        if final_state.get("quiz_question"):
                 print(f"💡 [생성된 퀴즈] {final_state['quiz_question']}")
                 print(f"정답: {final_state['quiz_answer']}")
                 print(f"해설: {final_state['quiz_explanation']}")
